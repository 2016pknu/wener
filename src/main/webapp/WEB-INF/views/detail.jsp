                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="flexslider post-images">
                                            <ul class="slides">
                                                <li data-thumb="resources/img/products/item-1.jpg">
                                                    <img alt="" src="resources/img/products/item-1.jpg" />
                                                </li>
                                                <li data-thumb="resources/img/products/item-2.jpg">
                                                    <img alt="" src="resources/img/products/item-2.jpg" />
                                                </li>
                                                <li data-thumb="resources/img/products/item-3.jpg">
                                                    <img alt="" src="resources/img/products/item-3.jpg" />
                                                </li>
                                                <li data-thumb="resources/img/products/item-4.jpg">
                                                    <img alt="" src="resources/img/products/item-4.jpg" />
                                                </li>
                                            </ul>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="widget">
                                ...
                                <div class="widget-body text-center">
                                    <img alt="avatar" src="resources/img/people/gie.jpg" class="seller-avatar img-responsive">
